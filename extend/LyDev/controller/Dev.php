...
namespace Extend\LyDev\controller;

use Common\CuteDB;
use Error;
use Exception;
use Extend\LyDev\library\Common;
use Extend\LyDev\library\Panel;
use Extend\LyDev\library\Storage;
use Extend\LyDev\Main;
use ExtFunc;
    ...
    public static function panel(Request $req, Response $resp)
    {
        if ($req->variable[0] != null) {
            ...
            if ($loader == "") {
                ...
                if (is_file($root_path . '/extdev/setting.json')) {
                    $setting = file_get_contents($root_path . '/extdev/setting.json');
            ...
            if ($loader == "panel.xml") {
                ...
                $path = ROOT_PATH . '/extend/' . $ext . '/extdev/';
